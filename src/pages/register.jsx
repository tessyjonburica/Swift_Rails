                ...
                <div className="row">
                    <div className="col-sm-12 col-lg-6 col-md-6 ps-5 pe-5 hero-bg d-flex justify-content-center align-items-center" >
                        <div className="">
                            ...
                            <h2 style={{ fontFamily: 'Outfit', fontSize: '56px', fontWeight: '700', lineHeight: '43px', letterSpacing: '-0.02em', textAlign: 'left', color: '#FFFFFF' }}>Book a train in the simplest way</h2>
                    ...
                    <div className="col-sm-12 col-lg-6 col-md-6  d-flex justify-content-center align-items-center">
                        <div className=" ">
                            ...
                            <form action="" method="postf">
                                ...
                                <input type="password" name="confirmPassword" placeholder="Confirm password" className="form-control pt-2 pb-2 mt-4 mb-2" />
                                <button style={{ backgroundColor: '#4001A8', color: '#fff', padding: "12px 25px" }} className="btn form-control rounded-pill mt-3">Continue</button>
                                ...
                                <div className="d-flex justify-content-between">
                                    ...
                                    <button className="btn btn-dark rounded-pill form-control ms-2" style={{padding: "12px 25px"}}>Sign Up with Apple</button>
                                </div>
                            </form>
                        </div>
                    </div>
